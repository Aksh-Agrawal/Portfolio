...
import { Download, Mail, Phone, MapPin, Calendar, GraduationCap, Code, Brain, Award, Trophy, Users, GitBranch, ExternalLink, User, Eye, FileText } from "lucide-react"
...
export function ResumeSection() {
  ...
  const resumeData = {
    personalInfo: {
      ...
      email: "aksh.agrawal@email.com",
      phone: "+91 98765 43210",
      website: "akshagrawal.dev",
      linkedin: "linkedin.com/in/aksh-agrawal",
    ...
    projects: [
      {
        ...
        description: "Developed an intelligent healthcare assistant using NLP and computer vision for symptom analysis and preliminary diagnosis.",
        duration: "2024",
        status: "Completed",
        achievements: [
      ...
      },
      {
        ...
        description: "Created an adaptive learning platform that personalizes content based on student performance and learning patterns.",
        duration: "2023",
        status: "Completed",
        achievements: [
        ...
        technologies: ["Next.js", "TypeScript", "Python", "Scikit-learn", "MongoDB"],
        github: "github.com/aksh-agrawal/smart-learning",
        demo: "smart-learning.vercel.app"
      },
      {
        name: "Real-time Object Detection System",
        description: "Developed a real-time object detection system using YOLO and OpenCV for security and surveillance applications.",
        duration: "2023",
        status: "Completed",
        achievements: [
    ...
    hackathons: [
      {
        ...
        position: "1st Place",
        description: "Built an AI-powered healthcare assistant with real-time symptom analysis",
        duration: "48 hours",
        participants: "200+",
      ...
      },
      {
        ...
        position: "Top 5",
        description: "Developed a real-time object detection system for security applications",
        duration: "36 hours",
        participants: "150+",
      ...
      },
      {
        name: "CodeFest 2023",
        position: "2nd Place",
        description: "Created a smart learning platform with adaptive content delivery",
        duration: "24 hours",
        participants: "100+",
  ...
  const loadPDF = async () => {
    try {
      // Try to read the PDF file using the file system API
      const pdfData = await window.fs.readFile('Aksh_Agrawal_Resume.pdf')
      ...
      // Fallback to public path if file system API fails
      return '/Aksh_Agrawal_Resume.pdf'
    }
  }
  ...
  return (
    <section id="resume" className="py-20 bg-gradient-to-br from-background via-background to-primary/5">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-6">
            My professional journey, skills, and achievements in AI development and interactive experiences
          </p>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="text-2xl font-bold text-primary mb-2">{resumeData.personalInfo.name}</h3>
                    <p className="text-lg text-muted-foreground mb-4">{resumeData.personalInfo.title}</p>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <a href={`https://${resumeData.personalInfo.github}`} target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                        {resumeData.personalInfo.github}
                      </a>
                    </div>
                    <div className="flex items-center gap-3">
                      <Users className="h-4 w-4 text-primary" />
                      <a href={`https://${resumeData.personalInfo.linkedin}`} target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
              ...
              <Card className="h-full">
                ...
                <CardContent>
                  {resumeData.education.map((edu, index) => (
                    <div key={index} className="border-l-2 border-primary pl-4 mb-6 last:mb-0">
                  ...
                  {resumeData.certifications.map((cert, index) => (
                    <div key={index} className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-primary">{cert.credential}</div>
                      </div>
                    </div>
                  ))}
                </div>
