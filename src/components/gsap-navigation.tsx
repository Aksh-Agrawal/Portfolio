...
export function GSAPNavigation() {
        ...
        onUpdate: (self) => {
          if (navRef.current) {
            ...
            gsap.to(navRef.current, {
              backgroundColor: `rgba(0, 0, 0, ${0.8 + progress * 0.2})`,
              backdropFilter: `blur(${10 + progress * 5}px)`,
              duration: 0.3
            })
          }
        }
  ...
  return (
    <motion.nav 
      ref={navRef}
      className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-lg border-b border-primary/10 shadow-lg"
    >
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          {/* Desktop Navigation */}
          <div ref={navItemsRef} className="hidden md:flex items-center gap-2">
            <NavigationMenu>
