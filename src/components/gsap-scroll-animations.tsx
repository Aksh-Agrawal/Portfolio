      ...
      const setInitialState = () => {
        switch (animation) {
          case "fadeInUp":
            ...
            break
          case "fadeInLeft":
            gsap.set(childElements, { opacity: 0, x: -50 })
            break
          case "fadeInRight":
            gsap.set(childElements, { opacity: 0, x: 50 })
            break
          case "fadeInDown":
            ...
            break
          case "scaleIn":
            gsap.set(childElements, { opacity: 0, scale: 0.8 })
            break
          case "slideInLeft":
            gsap.set(childElements, { opacity: 0, x: -100 })
            break
          case "slideInRight":
            gsap.set(childElements, { opacity: 0, x: 100 })
            break
          case "rotateIn":
            gsap.set(childElements, { opacity: 0, rotation: -180, scale: 0.8 })
            break
          case "bounceIn":
            gsap.set(childElements, { opacity: 0, scale: 0.3 })
            break
          default:
            gsap.set(childElements, { opacity: 0, y: 50 })
        }
